...
for (let i = 0; i < 300000; i++) {
    ...
    arr.push(random_english_small(3));
...
//     arr.push(random_english_small(3));
//     arr.push(random_english_small(4));
//     arr.push(generateRandomPhone());
//     arr.push(random_english_small(3));
//     arr.push(random_english_small(3));
//     arr.push(random_english_small(3));
...
xlsx.writeFile(book, "Emfo_Book_UpLoad_sample 30만명 테스트(그룹 x) 영어.xlsx");

// xlsx.writeFile(book, "Emfo_Book_UpLoad_sample 30만명 테스트(그룹 추가) 영어.xlsx");